...
class Battery():
    ...
    def upgrade_battery(self):
        """This method checks the battery size and sets the capacity to 100 if it isn't already."""
        if self.battery_size < 100:
           self.battery_size = 100
        else:
            print("The capacity is already 85")
...
class ElectricCar(Car):
    ...
    def __init__(self, make, model, year):
        ...
        Then initalize attribues specific to an electric car.
        """ 
...
# Making an instance from the Electric car class
...
# Calling the range method a second time
my_tesla.battery.get_range()